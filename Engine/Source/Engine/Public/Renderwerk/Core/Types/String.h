...
using FAnsiString = std::basic_string<char, std::char_traits<char>, TSTLAllocator<char>>;
using FAnsiStringView = std::string_view;
using FAnsiChar = char;

using FWideString = std::basic_string<wchar_t, std::char_traits<wchar_t>, TSTLAllocator<wchar_t>>;
