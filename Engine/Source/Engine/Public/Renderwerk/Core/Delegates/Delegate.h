...
/**
 * @brief A delegate represents an event that can be bound to a function.
 * @tparam TReturnValue The return value of the function.
 * @tparam TArguments The arguments of the function.
 */
