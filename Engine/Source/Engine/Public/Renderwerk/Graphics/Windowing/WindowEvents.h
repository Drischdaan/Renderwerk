...
struct RENDERWERK_API FWindowResizedEvent : IWindowEvent
{
public:
	FWindowResizedEvent()
...
struct RENDERWERK_API FWindowClientAreaResizedEvent : IWindowEvent
{
public:
...
struct RENDERWERK_API FWindowMovedEvent : IWindowEvent
{
public:
	FWindowMovedEvent()
...
struct RENDERWERK_API FWindowFocusChangedEvent : IWindowEvent
{
public:
